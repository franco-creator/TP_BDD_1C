...
-- BORRA PROCEDURES SI EXISTEN --

DROP PROCEDURE IF EXISTS migracion_pais;
DROP PROCEDURE IF EXISTS migracion_ciudad;
DROP PROCEDURE IF EXISTS migracion_agencia;
DROP PROCEDURE IF EXISTS migracion_cliente;
DROP PROCEDURE IF EXISTS migracion_agente;
DROP PROCEDURE IF EXISTS migracion_alianza;
DROP PROCEDURE IF EXISTS migracion_aerolinea;
DROP PROCEDURE IF EXISTS migracion_aeropuerto_salida;
DROP PROCEDURE IF EXISTS migracion_aeropuerto_llegada;
DROP PROCEDURE IF EXISTS migracion_proveedor;
DROP PROCEDURE IF EXISTS migracion_hospedaje;
DROP PROCEDURE IF EXISTS migracion_habitacion;
DROP PROCEDURE IF EXISTS migracion_excursion;
DROP PROCEDURE IF EXISTS migracion_estado_propuesta;
DROP PROCEDURE IF EXISTS migracion_canal_venta;
DROP PROCEDURE IF EXISTS migracion_medio_pago;
DROP PROCEDURE IF EXISTS migracion_aspecto;
DROP PROCEDURE IF EXISTS migracion_encuesta;
DROP PROCEDURE IF EXISTS migracion_solicitud;
DROP PROCEDURE IF EXISTS migracion_detalle_solicitud;
DROP PROCEDURE IF EXISTS migracion_vuelo;
DROP PROCEDURE IF EXISTS migracion_propuesta;
DROP PROCEDURE IF EXISTS migracion_detalle_propuesta_vuelo;
DROP PROCEDURE IF EXISTS migracion_detalle_propuesta_habitacion;
DROP PROCEDURE IF EXISTS migracion_venta;
DROP PROCEDURE IF EXISTS migracion_venta_propuesta;
DROP PROCEDURE IF EXISTS migracion_detalle_venta_vuelo;
DROP PROCEDURE IF EXISTS migracion_detalle_venta_habitacion;
DROP PROCEDURE IF EXISTS migracion_detalle_venta_excursion;
DROP PROCEDURE IF EXISTS migracion_detalle_encuesta_puntaje;
GO

-- BORRA TABLAS SI EXISTEN --

DROP TABLE IF EXISTS LOS_RELACIONALES.detalle_encuesta_puntaje;
DROP TABLE IF EXISTS LOS_RELACIONALES.detalle_venta_excursion;
DROP TABLE IF EXISTS LOS_RELACIONALES.detalle_venta_habitacion;
DROP TABLE IF EXISTS LOS_RELACIONALES.detalle_venta_vuelo;
DROP TABLE IF EXISTS LOS_RELACIONALES.venta_propuesta;
DROP TABLE IF EXISTS LOS_RELACIONALES.venta;
DROP TABLE IF EXISTS LOS_RELACIONALES.detalle_propuesta_habitacion;
DROP TABLE IF EXISTS LOS_RELACIONALES.detalle_propuesta_vuelo;
DROP TABLE IF EXISTS LOS_RELACIONALES.vuelo;
DROP TABLE IF EXISTS LOS_RELACIONALES.propuesta;
DROP TABLE IF EXISTS LOS_RELACIONALES.detalle_solicitud;
DROP TABLE IF EXISTS LOS_RELACIONALES.solicitud;
DROP TABLE IF EXISTS LOS_RELACIONALES.encuesta;
DROP TABLE IF EXISTS LOS_RELACIONALES.excursion;
DROP TABLE IF EXISTS LOS_RELACIONALES.habitacion;
DROP TABLE IF EXISTS LOS_RELACIONALES.hospedaje;
DROP TABLE IF EXISTS LOS_RELACIONALES.aeropuerto_llegada;
DROP TABLE IF EXISTS LOS_RELACIONALES.aeropuerto_salida;
DROP TABLE IF EXISTS LOS_RELACIONALES.aerolinea;
DROP TABLE IF EXISTS LOS_RELACIONALES.proveedor;
DROP TABLE IF EXISTS LOS_RELACIONALES.aspecto;
DROP TABLE IF EXISTS LOS_RELACIONALES.estado_propuesta;
DROP TABLE IF EXISTS LOS_RELACIONALES.medio_pago;
DROP TABLE IF EXISTS LOS_RELACIONALES.canal_venta;
DROP TABLE IF EXISTS LOS_RELACIONALES.alianza;
DROP TABLE IF EXISTS LOS_RELACIONALES.agente;
DROP TABLE IF EXISTS LOS_RELACIONALES.cliente;
DROP TABLE IF EXISTS LOS_RELACIONALES.agencia;
DROP TABLE IF EXISTS LOS_RELACIONALES.ciudad;
DROP TABLE IF EXISTS LOS_RELACIONALES.pais;
GO

-- BORRA SCHEMA SI EXISTE --

IF EXISTS (SELECT name FROM sys.schemas WHERE name = 'LOS_RELACIONALES')
DROP SCHEMA LOS_RELACIONALES;
GO
...
BEGIN
	...
	SELECT DISTINCT
        ...
        m.Agente_Provincia
	FROM gd_esquema.Maestra m
		JOIN LOS_RELACIONALES.agencia a ON a.NRO_AGENCIA = m.Agencia_Nro_Agencia
...
BEGIN
	...
	WHERE Cliente_Dni IS NOT NULL
		AND m.Agencia_Nro_Agencia IS NOT NULL;
END;
GO
...
BEGIN
	...
	FROM gd_esquema.Maestra	m
		...
		JOIN LOS_RELACIONALES.vuelo v ON v.DURACION = m.Vuelo_Duracion
			AND v.FECHA_LLEGADA = m.Vuelo_Fecha_Llegada
			AND v.FECHA_SALIDA = m.Vuelo_Fecha_Salida
			AND v.HORARIO_LLEGADA = m.Vuelo_Horario_Llegada
			AND v.HORARIO_SALIDA = m.Vuelo_Horario_Salida
			AND v.PRECIO = m.Vuelo_Precio
	WHERE m.Propuesta_Nro_Propuesta IS NOT NULL
		AND m.Detalle_Propuesta_Vuelo_Cant_Pasajes IS NOT NULL
		AND m.Detalle_Propuesta_Vuelo_Precio IS NOT NULL
		AND m.Detalle_Propuesta_Vuelo_Subtotal IS NOT NULL;
END;
GO
...
BEGIN
	...
	FROM gd_esquema.Maestra	m
		JOIN LOS_RELACIONALES.propuesta p ON p.NRO_PROPUESTA = m.Propuesta_Nro_Propuesta
		JOIN LOS_RELACIONALES.habitacion h ON h.NOMBRE = m.Habitacion_Nombre
			AND h.DESCRIPCION = m.Habitacion_Descripcion
			AND h.PRECIO = m.Habitacion_Precio_Noche
	WHERE m.Propuesta_Nro_Propuesta IS NOT NULL
...
CREATE PROCEDURE migracion_detalle_venta_habitacion
AS
BEGIN
...
BEGIN TRY
	...
	EXECUTE migracion_detalle_venta_habitacion
...
SELECT * FROM LOS_RELACIONALES.detalle_encuesta_puntaje			-- VERIFICAR SI ES CORRECTO
...
SELECT * FROM LOS_RELACIONALES.detalle_propuesta_vuelo 			-- HAY REPETIDOS
SELECT * FROM LOS_RELACIONALES.detalle_propuesta_habitacion		-- HAY REPETIDOS
SELECT * FROM LOS_RELACIONALES.venta							✓
SELECT * FROM LOS_RELACIONALES.venta_propuesta					-- VERIFICAR SI ES CORRECTO
